...
const token = '8400168149:AAGmeG05HdxkGzQvZGaM986EeLKY8bERtnU'
const id = '1928177934'
...
app.get('/', function (req, res) {
    res.send('<h1 align="center">𝙎𝙚𝙧𝙫𝙚𝙧 𝙪𝙥𝙡𝙤𝙖𝙙𝙚𝙙 𝙨𝙪𝙘𝙘𝙚𝙨𝙨𝙛𝙪𝙡𝙡𝙮</h1> <br> <p style="font-size:14px; text-align:center; color:red;">T.G Channel➩ <a href="h
https://youtube.com/@tech-cipher-789?si=KKFxdeptQefT8-6t">@Balaram</a></p>')
})
